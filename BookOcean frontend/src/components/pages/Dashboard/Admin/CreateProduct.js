...
const CreateProduct = () => {
  ...
  const addProduct = async (e) => {
    ...
    } else if (productDetails.author === "") {
      setError({ author: "This field is required" });
    ...
    } else if (productDetails.genre === "") {
      setError({ genre: "This field is required" });
      ...
      <Box p={3}>
        <Grid container spacing={2}>
          <Grid item xs={12} md={7} height="100%">
            ...
            >
              <Typography pb={1}>Book Gallery</Typography>
              <Divider />
              <Box mt={2}>
                <Typography
                  variant="body2"
          ...
          <Grid item xs={12} md={5} height="100%">
            <Card
              ...
              sx={{ p: 2, boxShadow: "0 3px 3px rgba(56,65,74,0.1)" }}
            >
              <Typography pb={1}>Book Categories </Typography>
              <Divider></Divider>
              <Typography
                variant="body2"
                py={2}
            ...
            >
              <Typography pb={1}> Book Genres </Typography>
              <Divider></Divider>
              <Typography
                variant="body2"
                py={2}
            ...
            <Card
              ...
              sx={{ p: 2, boxShadow: "0 3px 3px rgba(56,65,74,0.1)", mt: 2 }}
            >
              <Typography pb={1}> Book Availability </Typography>
              <Divider></Divider>
              <Typography
                variant="body2"
                py={2}
