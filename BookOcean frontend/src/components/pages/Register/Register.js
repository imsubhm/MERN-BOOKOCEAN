      ...
      await axios
        ...
        .catch((err) => {
          if (err.response.data.error.toLowerCase().includes("email")) {
            ...
            err.response.data.error.toLowerCase().includes("firstname")
          ) {
            setError({ firstName: err.response.data.error });
          } else if (
            err.response.data.error.toLowerCase().includes("lastname")
          ) {
            setError({ lastName: err.response.data.error });
          } else if (
            err.response.data.error.toLowerCase().includes("confirmpassword")
          ) {
  ...
  return (
    <>
      <Box sx={{ px: { md: 16, xs: 4 } }} my={5}>
        <Card
          variant="outlined"
          sx={{ boxShadow: "0 3px 3px rgba(56,65,74,0.1)" }}
        >
          <Grid container>
                ...
                >
                  <Box sx={{ p: 4, color: "white" }}>
                    ...
                    <Typography sx={{ textAlign: "center", mt: 2 }}>
                      Sign up to use all features of this website and discover a
            ...
            <Grid item xs={12} md={6} sx={{ p: { xs: 4, lg: 6 } }}>
              ...
              >
                Sign Up to Bookocean
              </Typography>
              <Typography sx={{ fontSize: "14px", textAlign: "center", pt: 1 }}>
                Get your Free Bookocean account now....
              </Typography>
