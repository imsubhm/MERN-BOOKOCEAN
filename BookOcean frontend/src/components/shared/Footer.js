        ...
        <Grid container sx={{ px: { md: 16, xs: 4 } }}>
          ...
          <Grid item xs={12} md={6} lg={3} sx={{ mt: { lg: 0, xs: 3 } }}>
            ...
            <div style={style}>
              ...
              />
              <Typography>221B Baker Street </Typography>
            </div>
            <div style={style}>
              <Phone sx={{ borderRadius: "50%", p: 1, bgcolor: "#FF8E78" }} />
              <Typography> +91 800 123 1234 </Typography>
            </div>
            <div style={style}>
              <Email sx={{ borderRadius: "50%", p: 1, bgcolor: "#FF8E78" }} />
              <Typography> bookocean@email.com </Typography>
            </div>
          </Grid>
        </Grid>
        {goTopBtn && (
      ...
      >
        <Grid item xs={12} lg={6}>
          <Typography sx={{ textAlign: { xs: "center", lg: "initial" } }}>
            &copy; 2023 Bookocean. All Rights Reserved.
          </Typography>
        </Grid>
        <Grid
          item
